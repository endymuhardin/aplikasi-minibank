...
Background:
  * url baseUrl  
  * def testData = read('classpath:csv/usecase/personal-customer-registration-validation.csv')
...
Examples:
| read('classpath:csv/usecase/personal-customer-registration-validation.csv') |