...
INSERT INTO products (id, product_code, product_name, product_type, product_category, description, is_active, is_default, currency, minimum_opening_balance, minimum_balance, maximum_balance, daily_withdrawal_limit, monthly_transaction_limit, profit_sharing_ratio, profit_sharing_type, profit_distribution_frequency, nisbah_customer, nisbah_bank, is_shariah_compliant, monthly_maintenance_fee, atm_withdrawal_fee, inter_bank_transfer_fee, below_minimum_balance_fee, account_closure_fee, free_transactions_per_month, excess_transaction_fee, allow_overdraft, require_maintaining_balance, min_customer_age, max_customer_age, allowed_customer_types, required_documents, created_date, updated_date, created_by) 
VALUES 
('11111111-1111-1111-1111-111111111111', 'SAV001', 'Basic Savings Account', 'SAVINGS', 'Regular Savings', 'Basic savings account for individual customers', true, true, 'IDR', 50000.00, 10000.00, null, 5000000.00, 50, 0.0275, 'MUDHARABAH', 'MONTHLY', 0.7000, 0.3000, true, 2500.00, 5000.00, 7500.00, 10000.00, 0.00, 10, 2500.00, false, true, 17, null, 'PERSONAL', 'KTP, NPWP (optional)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM'),
('22222222-2222-2222-2222-222222222222', 'SAV002', 'Premium Savings Account', 'SAVINGS', 'Premium Savings', 'Premium savings account with higher profit sharing', true, false, 'IDR', 1000000.00, 500000.00, null, 10000000.00, 100, 0.0350, 'MUDHARABAH', 'MONTHLY', 0.7000, 0.3000, true, 0.00, 0.00, 5000.00, 25000.00, 0.00, 25, 2500.00, false, true, 21, null, 'PERSONAL', 'KTP, NPWP, Slip Gaji', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM'),
('33333333-3333-3333-3333-333333333333', 'CHK001', 'Basic Checking Account', 'CHECKING', 'Regular Checking', 'Basic checking account with overdraft facility', true, false, 'IDR', 100000.00, 50000.00, null, 20000000.00, 100, 0.0100, 'WADIAH', 'MONTHLY', NULL, NULL, true, 5000.00, 5000.00, 7500.00, 15000.00, 10000.00, 20, 3000.00, true, true, 18, null, 'PERSONAL', 'KTP, NPWP, Slip Gaji', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM'),
('44444444-4444-4444-4444-444444444444', 'SAV003', 'Corporate Savings Account', 'SAVINGS', 'Corporate', 'Savings account for corporate customers', true, false, 'IDR', 5000000.00, 1000000.00, null, 50000000.00, 200, 0.0300, 'MUDHARABAH', 'MONTHLY', 0.7000, 0.3000, true, 15000.00, 5000.00, 5000.00, 50000.00, 25000.00, 50, 5000.00, false, true, null, null, 'CORPORATE', 'Akta Pendirian, SIUP, TDP, NPWP', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM'),
