-- Setup test data for deposit functionality tests
...
('11111111-1111-1111-aaaa-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', '01234567-8901-2345-6789-012345678901', 'ACC0000001', 'John Doe Savings', 500.00, 'ACTIVE', CURRENT_DATE, 'system', CURRENT_TIMESTAMP, 'system', CURRENT_TIMESTAMP),
('22222222-2222-2222-bbbb-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '22222222-2222-2222-2222-222222222222', '01234567-8901-2345-6789-012345678901', 'ACC0000002', 'ABC Company Checking', 10000.00, 'ACTIVE', CURRENT_DATE, 'system', CURRENT_TIMESTAMP, 'system', CURRENT_TIMESTAMP),
