...
INSERT INTO customers (id, customer_number, customer_type, email, phone_number, address, city, postal_code, country, status, created_by, created_date, updated_by, updated_date)
VALUES
