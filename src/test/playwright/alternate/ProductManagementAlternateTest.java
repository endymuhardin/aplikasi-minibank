package id.ac.tazkia.minibank.playwright.alternate;

import id.ac.tazkia.minibank.config.BasePlaywrightTest;
import id.ac.tazkia.minibank.playwright.pages.DashboardPage;
import id.ac.tazkia.minibank.playwright.pages.LoginPage;
import id.ac.tazkia.minibank.playwright.pages.ProductManagementPage;
...
class ProductManagementAlternateTest extends BasePlaywrightTest {
    ...
    @CsvSource({
        ...
        "'PRODUCT_CODE_THAT_IS_TOO_LONG_FOR_DATABASE', 'Test Product', 'TABUNGAN_WADIAH', 'Test Category', 'Too long product code'"
    })
    ...
    void shouldValidateProductFormFields(String productCode, String productName, String productType, String category, String testCase) {
        ...
        assertTrue(page.url().contains("/product/create") || productPage.hasValidationErrors(), 
