...
class AccountRepositoryTest extends BaseRepositoryTest {
    ...
    private void setupTestCustomersAndProducts() {
        ...
        savingsBasic.setInterestRate(new BigDecimal("0.0275"));
        savingsBasic.setInterestCalculationType(Product.InterestCalculationType.DAILY);
        savingsBasic.setInterestPaymentFrequency(Product.InterestPaymentFrequency.MONTHLY);
        ...
        savingsPremium.setInterestRate(new BigDecimal("0.0350"));
        savingsPremium.setInterestCalculationType(Product.InterestCalculationType.DAILY);
        savingsPremium.setInterestPaymentFrequency(Product.InterestPaymentFrequency.MONTHLY);
        ...
        savingsCorporate.setInterestRate(new BigDecimal("0.0300"));
        savingsCorporate.setInterestCalculationType(Product.InterestCalculationType.DAILY);
        savingsCorporate.setInterestPaymentFrequency(Product.InterestPaymentFrequency.MONTHLY);
        ...
        checkingBasic.setInterestRate(new BigDecimal("0.0100"));
        checkingBasic.setInterestCalculationType(Product.InterestCalculationType.DAILY);
        checkingBasic.setInterestPaymentFrequency(Product.InterestPaymentFrequency.MONTHLY);
        ...
        checkingPremium.setInterestRate(new BigDecimal("0.0150"));
        checkingPremium.setInterestCalculationType(Product.InterestCalculationType.DAILY);
        checkingPremium.setInterestPaymentFrequency(Product.InterestPaymentFrequency.MONTHLY);
