...
class ProductRestControllerSimpleTest {
    ...
    @Import(ProductRestControllerSimpleTest.SecurityTests.SecurityTestConfig.class)
    @DisplayName("Security Tests")
    class SecurityTests {

        /**
         * Test security configuration that requires authentication for API endpoints.
         * This inner class prevents the config from being picked up by other tests.
         */
        @Configuration
        @EnableWebSecurity
